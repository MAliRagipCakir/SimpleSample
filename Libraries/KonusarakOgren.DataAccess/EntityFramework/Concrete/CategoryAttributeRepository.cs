...
{
    public class CategoryAttributeRepository : BaseRepository<CategoryAttribute, Guid>, ICategoryAttributeRepository
    {
        public CategoryAttributeRepository(ApplicationDbContext applicationDbContext) : base(applicationDbContext)
        {
        }
    }
}
